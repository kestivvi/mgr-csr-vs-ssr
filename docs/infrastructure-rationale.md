...
*   **Clean Data:** By over-provisioning the generator for capacity runs, we guarantee that any latency measured is caused solely by the **Application Server**, removing the "noisy generator" variable from the thesis data.

## Summary Table

| Role | Instance Type | vCPU | RAM | Rationale |
| :--- | :--- | :--- | :--- | :--- |
| **Application Server** | `c8g.medium` | 1 | 2 GiB | Measures single-core efficiency; saturates early for clear data. |
